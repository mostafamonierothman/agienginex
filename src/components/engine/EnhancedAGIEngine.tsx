        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-slate-700/50 p-4 rounded">
              ...
              <div className="text-white font-bold text-xl">{agiState.intelligence.toFixed(1)}%</div>
            ...
            <div className="bg-slate-700/50 p-4 rounded">
              ...
              <div className="text-white font-bold text-xl">{agiState.efficiency.toFixed(1)}%</div>
              <div className="w-full bg-slate-600 rounded-full h-2 mt-2">
                <div 
            ...
            <div className="bg-slate-700/50 p-4 rounded">
              <div className="text-gray-400 text-sm">Autonomy</div>
              <div className="text-white font-bold text-xl">{agiState.autonomyLevel.toFixed(1)}%</div>
              <div className="w-full bg-slate-600 rounded-full h-2 mt-2">
                <div 
            ...
            <div className="bg-slate-700/50 p-4 rounded">
              ...
              <div className="text-white font-bold text-xl">${agiState.revenue.toFixed(0)}</div>
              <div className="text-green-400 text-sm">+{(agiState.autonomyLevel * 50).toFixed(0)}/cycle</div>
            </div>
          </div>
          ...
          <div className="bg-slate-700/30 border border-slate-600 rounded p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-yellow-400 font-semibold">Current Decision:</span>
            </div>
            <div className="text-white">{agiState.lastDecision}</div>
          </div>

          {/* Emergent Behaviors */}
          {agiState.emergentBehaviors.length > 0 && (
            <div className="bg-slate-700/30 border border-purple-600 rounded p-4">
              <div className="flex items-center gap-2 mb-2">
                <Zap className="w-4 h-4 text-purple-400" />
                <span className="text-purple-400 font-semibold">Emergent Behaviors:</span>
              </div>
